...
public class MagicPacket
{
    ...
    public MagicPacket(Context context) {
    ...
    public void send(String mac, String ip) throws UnknownHostException, SocketException, IOException, IllegalArgumentException
    {
        send(mac, ip, PORT);
    }

    public void send(String mac, String ip, int port) throws UnknownHostException, SocketException, IOException, IllegalArgumentException
    {
